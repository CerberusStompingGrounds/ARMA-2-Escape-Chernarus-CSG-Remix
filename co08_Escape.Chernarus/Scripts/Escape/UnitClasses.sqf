...
drn_arr_AmmoClassAlwaysInAmmoDepots = ["RULaunchersBox"];
// Ammo classes maybe appearing at ammo depots (40% chance each)
drn_arr_AmmoClassMaybeInAmmoDepots = ["RUBasicAmmunitionBox", "RUVehicleBox", "RUBasicWeaponsBox", "RUSpecialWeaponsBox", "RUOrdnanceBox"];
